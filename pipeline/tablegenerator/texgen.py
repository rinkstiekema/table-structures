...
class TexGenerator():
    def __init__(self):
        ...
        self.lengths = r"""\setlength{\aboverulesep}{0pt}\setlength{\belowrulesep}{0pt}\setlength\tabcolsep{1em}"""            
        self.lengths_outlines = r"""\setlength{\aboverulesep}{0.1pt}\setlength{\belowrulesep}{0.1pt}\setlength\tabcolsep{1em}\setlength{\heavyrulewidth}{0.4pt}\setlength{\lightrulewidth}{0.4pt}"""
    ...
    def generate_tex(self, table):
        ...
        for idx, i in enumerate(sorted(occurences, reverse=True)):
            ...
            latex = latex[:i] + r"\\ \arrayrulecolor{"+ color +r"} \midrule \arrayrulecolor{black} " + latex[i+len(r"\\\\")-1:]
